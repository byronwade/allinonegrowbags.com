          ...
          <div className="md:w-1/2">
            {steps.map((step, index) => (
              <div key={index} className="flex items-start mb-8 group">
                <div className="w-12 h-12 rounded-full bg-purple flex items-center justify-center text-lg font-bold text-white mr-4 flex-shrink-0 group-hover:bg-purple-dark transition-colors">
                  {index + 1}
                </div>
                <div>
          ...
          <div className="md:w-1/2">
            <div className="relative">
              ...
              <Image
                ...
                alt="ZugzBag All-in-One Mushroom Grow Bag Process"
                width={500}
                height={500}

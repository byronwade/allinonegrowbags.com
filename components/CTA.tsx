			...
			<div className="container mx-auto">
				<div className="flex flex-col md:flex-row items-center mb-12">
					<div className="md:w-1/2 mb-10 md:mb-0">
						...
						<p className="text-xl mb-8 text-gray-300">Perfect for commercial growers and cultivation enthusiasts. The more you order, the more you save!</p>
					...
					<div className="md:w-1/2 md:pl-12">
						<Image src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/sterile-all-in-one-mushroom-grow-bag-4-lbs-substrate-and-grain-filter-patch-112491-Hkoucg5alJXunr83eIolGhCMiHCxR3.webp" alt="ZugzBag Mushroom Grow Bag" width={500} height={500} className="rounded-lg shadow-2xl mx-auto" />
					</div>
				</div>
			</div>
		</section>

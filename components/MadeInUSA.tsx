			...
			<div className="container mx-auto">
				<div className="flex flex-col md:flex-row items-center justify-between">
					<div className="md:w-1/2 mb-8 md:mb-0">
						...
						<p className="text-xl mb-6 text-gray-300">Every ZugzBag all-in-one mushroom grow bag is crafted with care in Santa Cruz, California. We're committed to supporting local economies and ensuring the highest quality standards for our products.</p>

...
export const MadeInUSA: React.FC<MadeInUSAProps> = ({ heading, description, benefits, image, flagImage }) => {
	return (
			...
			<div className="flex flex-col md:flex-row items-center justify-between">
				...
				<div className="md:w-1/2 flex justify-center">
					<div className="relative">
						<Image src={image.url} alt={image.alt} width={600} height={450} className="rounded-lg shadow-2xl" />
						<div className="absolute -bottom-3 -right-3 md:-bottom-4 md:-right-4 bg-white p-3 md:p-4 rounded-lg shadow-xl">
							<Image src={flagImage.url} alt={flagImage.alt} width={100} height={60} className="rounded" />
						</div>
					</div>
				</div>
			</div>
